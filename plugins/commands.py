...
"""My Dev https://t.me/adarsh2626

    # Buttons
    buttons = [
        [
            InlineKeyboardButton('My Parent Team👨‍✈️', url=f"https://t.me/thealphabotz")
        ]
    ]
    await m.reply_text(
        text=text,
...
async def nxt(c, m):
    if m.data == "nxt":
        buttons = [[
            ...
            InlineKeyboardButton('S̷̨͎̘̪̫̮͔̲̉t̴͖̫̼̏͒̎̈́̏̿̐̿̕ò̴̺̗̍̍̎̀͐̿ṕ̸̡̺̳͇͚̑͐͜' , callback_data='style+stop'),
